...
function StartGame(props) {
    return (
        <div className={props.status === "Welcome" ? "fixed max-w-md px-8 py-5 mt-56 bg-gray-100 border-2 rounded-md z-50 ease-in-out hover:scale-110 duration-500" : "hidden"}>
